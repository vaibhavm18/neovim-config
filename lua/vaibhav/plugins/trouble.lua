return {
  ...
  keys = {
    ...
    { "<leader>tf", "<cmd>Trouble diagnostics toggle filter.buf=0<CR>", desc = "Open trouble document diagnostics" },
    ...
    { "<leader>to", "<cmd>Trouble todo toggle<CR>", desc = "Open todos in trouble" },
  },
}
